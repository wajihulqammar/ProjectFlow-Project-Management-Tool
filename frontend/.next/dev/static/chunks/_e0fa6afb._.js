...
function SettingsPage() {
    ...
    const [jobTitle, setJobTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(user?.jobTitle || '');
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "SettingsPage.useMutation[updateMutation]": (data)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/auth/update-profile', data)
        }["SettingsPage.useMutation[updateMutation]"],
        onSuccess: {
            "SettingsPage.useMutation[updateMutation]": (res)=>{
...
_s(SettingsPage, "kCrbRHi38JtSIMIzYcdCloCFfjk=", false, function() {
    return [
...
//# sourceMappingURL=_e0fa6afb._.js.map